				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="处置账号" prop="chuzhizhanghao">
							<el-input class="list_inp" v-model="user.chuzhizhanghao" readonly placeholder="处置账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="处置员" prop="chuzhiyuan">
							<el-input class="list_inp" v-model="user.chuzhiyuan"  placeholder="处置员" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in chuzhiyuanxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="chuzhiyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const tableName = ref('chuzhiyuan')
	const user = ref({})
	const chuzhiyuanxingbieLists = ref([])
	const init = () => {
		chuzhiyuanxingbieLists.value = "男,女".split(',')
	}
	const chuzhiyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.chuzhizhanghao)){
			context?.$toolUtil.message(`处置账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
		...
		if((!user.value.chuzhiyuan)){
			context?.$toolUtil.message(`处置员不能为空`,'error')
			return false
		}
