	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">处置账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.chuzhizhanghao" 
						 placeholder="请输入处置账号"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">处置员：</div>
					<el-input class="list_inp"
						 v-model="registerForm.chuzhiyuan" 
						 placeholder="请输入处置员"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.chuzhizhanghao)){
		...
		if((!registerForm.value.chuzhiyuan)){
