				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="登记账号" prop="dengjizhanghao">
							<el-input class="list_inp" v-model="user.dengjizhanghao" readonly placeholder="登记账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="登记员" prop="dengjiyuan">
							<el-input class="list_inp" v-model="user.dengjiyuan"  placeholder="登记员" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in dengjiyuanxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="dengjiyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const tableName = ref('dengjiyuan')
	const user = ref({})
	const dengjiyuanxingbieLists = ref([])
	const init = () => {
		dengjiyuanxingbieLists.value = "男,女".split(',')
	}
	const dengjiyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.dengjizhanghao)){
			context?.$toolUtil.message(`登记账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
		...
		if((!user.value.dengjiyuan)){
			context?.$toolUtil.message(`登记员不能为空`,'error')
			return false
		}
