	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">登记账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.dengjizhanghao" 
						 placeholder="请输入登记账号"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">登记员：</div>
					<el-input class="list_inp"
						 v-model="registerForm.dengjiyuan" 
						 placeholder="请输入登记员"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.dengjizhanghao)){
		...
		if((!registerForm.value.dengjiyuan)){
