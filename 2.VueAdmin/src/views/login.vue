	...
	<div>
		<div class="login_view">
			<el-form :model="loginForm" class="login_form">
				<div class="title_view">医疗废物管理系统登录</div>
				...
				<div class="btn_view">
					...
					<el-button class="register" type="primary" @click="handleRegister('dengjiyuan')">注册登记员</el-button>
					<el-button class="register" type="primary" @click="handleRegister('zhuanyunyuan')">注册转运员</el-button>
					<el-button class="register" type="primary" @click="handleRegister('chuzhiyuan')">注册处置员</el-button>
				</div>
			</el-form>
		</div>
