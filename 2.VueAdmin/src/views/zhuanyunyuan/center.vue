				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="转运账号" prop="zhuanyunzhanghao">
							<el-input class="list_inp" v-model="user.zhuanyunzhanghao" readonly placeholder="转运账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="转运员" prop="zhuanyunyuan">
							<el-input class="list_inp" v-model="user.zhuanyunyuan"  placeholder="转运员" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in zhuanyunyuanxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="zhuanyunyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const tableName = ref('zhuanyunyuan')
	const user = ref({})
	const zhuanyunyuanxingbieLists = ref([])
	const init = () => {
		zhuanyunyuanxingbieLists.value = "男,女".split(',')
	}
	const zhuanyunyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.zhuanyunzhanghao)){
			context?.$toolUtil.message(`转运账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
		...
		if((!user.value.zhuanyunyuan)){
			context?.$toolUtil.message(`转运员不能为空`,'error')
			return false
		}
