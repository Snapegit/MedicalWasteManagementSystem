	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">转运账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.zhuanyunzhanghao" 
						 placeholder="请输入转运账号"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">转运员：</div>
					<el-input class="list_inp"
						 v-model="registerForm.zhuanyunyuan" 
						 placeholder="请输入转运员"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.zhuanyunzhanghao)){
		...
		if((!registerForm.value.zhuanyunyuan)){
